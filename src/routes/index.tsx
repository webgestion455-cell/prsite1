      ...
      <footer className="border-t border-border bg-card py-10 text-xs text-muted-foreground sm:text-sm">
        <div className="container mx-auto px-4">
          <div className="grid gap-6 sm:grid-cols-2 md:grid-cols-4">
            <div>
              <p className="font-serif text-base font-medium text-foreground">BNP PARIBAS</p>
            ...
            <div>
              ...
              <ul className="mt-3 space-y-2">
                ...
                <li><a href="mailto:support_bnpparibas@nowelio.com" className="hover:text-accent">support@bnpparibas.com</a></li>
                <li><a href="tel:+393500366867" className="hover:text-accent">+39 350 036 6867</a></li>
              </ul>
            </div>
          </div>
          <p className="mt-8 text-center">© {new Date().getFullYear()} BNP PARIBAS. {t("landing.footer.rights")}</p>
        </div>
      </footer>
    </div>
  );
